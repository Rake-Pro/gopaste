// Command gopaste is a small self-hosted pastebin. See docs/DESIGN.md for the
...
func run(cfg config.Config) error {
	...
	srv := &http.Server{
		...
		ReadTimeout:       30 * time.Second, // bounds slow-body / slowloris
...
// preloadDocuments seeds the store with the embedded "about" document so it is
// always reachable at a stable key. Returns the set of preloaded keys, whose
